...
public class ModelMenuItem extends ModelWidget {
    ...
    private ModelMenuItem(Element menuItemElement, ModelMenu modelMenu, ModelMenuItem parentMenuItem) {
        ...
        Debug.log("ModelMenuItem LOG1:"+modelMenu.getName());
        Debug.log("ModelMenuItem LOG5:"+modelMenu.toString());
        Debug.log("ModelMenuItem LOG3:"+menuItemElement.getLocalName());
        Debug.log("ModelMenuItem LOG4:"+menuItemElement.getAttribute("name"));
        Debug.log("ModelMenuItem LOG7:"+modelMenu.getMenuLocation());
