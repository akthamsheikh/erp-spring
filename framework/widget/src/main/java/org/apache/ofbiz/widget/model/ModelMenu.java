...
public class ModelMenu extends ModelWidget {
    ...
    public ModelMenu(Element menuElement, String menuLocation, VisualTheme visualTheme) {
        ...
        for (Element itemElement : itemElements) {
            ...
            Debug.log("modelMenu Item Name:"+modelMenuItem.getName());
            Debug.log("modelMenu Name:"+this.getName());
            Debug.log("menuLocation:"+menuLocation);
          //Aktham
            if(isInVersion(this.getName(), menuLocation, modelMenuItem.getName())) {
    ...
    private HashMap<String, String> addItemList(String path, String menuName, String itemName) {
    ...
    public List<HashMap<String, String>> getVersionMenues(){
    	List<HashMap<String, String>> menusdata = new ArrayList<HashMap<String, String>>();
    	HashMap<String, String> item = new HashMap<String, String>();
    	//item = addItemList("component://party/widget/partymgr/PartyMenus.xml", "PartyClassificationTabBar", "EditPartyClassificationGroupParties");
    	item = addItemList("component://dummy/widget/dummy/DummyMenus.xml", "DummyTabBar", "EditDummy");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "invoices");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "payments");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "PaymentGroup");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "transaction");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "billingaccount");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "FindFinAccount");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "billingaccount");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "billingaccount");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "ListFixedAssets");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "ListBudgets");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "GlobalGLSettings");
    	menusdata.add(item);
    	item = addItemList("component://myaccounting/widget/AccountingMenus.xml", "AccountingAppBar", "companies");
    	menusdata.add(item);
    	
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "invoices");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "payments");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "PaymentGroup");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "transaction");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "billingaccount");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "FindFinAccount");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "billingaccount");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "billingaccount");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "ListFixedAssets");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "ListBudgets");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "GlobalGLSettings");
    	menusdata.add(item);
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "AccountingAppBar", "companies");
    	menusdata.add(item);
    	
    	item = addItemList("component://accounting/widget/AccountingMenus.xml", "InvoiceTabBar", "commissionRun");
    	menusdata.add(item);
    ...
    public boolean isInVersion(String modelMenuName, String menuLocation, String modelMenuItemName) {
    	boolean isInVersion = false;
    	List<HashMap<String, String>> notInVersionItems = getVersionMenues();
    	if(notInVersionItems.size()>0)
    	for(HashMap<String, String> item: notInVersionItems) {
    		if(item.get("path").toString().equals(menuLocation) 
    				&& item.get("menuName").toString().equals(modelMenuName) 
    				&& item.get("itemName").toString().equals(modelMenuItemName) ) {
    			isInVersion = true;
    		}
    	}
    	return isInVersion;
