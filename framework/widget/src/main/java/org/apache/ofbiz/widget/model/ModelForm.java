    ...
    protected ModelForm(Element formElement, String formLocation, ModelReader entityModelReader, DispatchContext dispatchContext, String defaultType) {
        ...
        for (Element fieldElement : UtilXml.childElementList(formElement, "field")) {
            ...
            if ("multi".equals(thisType) && fieldInfo instanceof ModelFormField.SubmitField) {
                ...
                //Aktham all fields heare
            	if(builder.getFieldName().equals("statusId") &&
                    	builder.getModelForm().getFormLocation().equals("component://accounting/widget/InvoiceForms.xml") &&
                     	(builder.getModelForm().getName().equals("FindInvoices") || builder.getModelForm().getName().equals("ListInvoices"))
            			) {
        ...
        for (ModelFormFieldBuilder builder : fieldBuilderList) {
        	//Aktham
        	Debug.log("getFieldName:"+builder.getFieldName());
        	Debug.log("getFormLocation:"+builder.getModelForm().getFormLocation());
        	Debug.log("getName:"+builder.getModelForm().getName());
        	
        	if(builder.getFieldName().equals("statusId") &&
                	builder.getModelForm().getFormLocation().equals("component://accounting/widget/InvoiceForms.xml") &&
                 	builder.getModelForm().getName().equals("FindInvoices")
        			) {
