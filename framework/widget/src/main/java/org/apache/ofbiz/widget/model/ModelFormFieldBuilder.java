...
public class ModelFormFieldBuilder {
    ...
    public ModelFormFieldBuilder(Element fieldElement, ModelForm modelForm, ModelReader entityModelReader,
        ...
        /*Aktham
        2024-10-28 15:28:25,138 |jsse-nio-8443-exec-6 |NoModule |O| Field Name XX: filterByEntityName
        2024-10-28 15:28:25,138 |jsse-nio-8443-exec-6 |NoModule |O| Field FieldName XX: filterByEntityName
        2024-10-28 15:28:25,138 |jsse-nio-8443-exec-6 |NoModule |O| Field FieldType XX: text
        2024-10-28 15:28:25,138 |jsse-nio-8443-exec-6 |NoModule |O| Field Field form name XX: FilterEntities
        2024-10-28 15:28:25,138 |jsse-nio-8443-exec-6 |NoModule |O| Field Field form type XX: single
        2024-10-28 15:28:25,138 |jsse-nio-8443-exec-6 |NoModule |O| Field Field form location XX: component://webtools/widget/EntityForms.xml
        	*/
        Debug.log("Field Name XX: "+this.getName()); 
        Debug.log("Field FieldName XX: "+this.getFieldName());
        Debug.log("Field FieldType XX: "+this.getFieldType()); 
        Debug.log("Field Field form name XX: "+this.modelForm.getName()); 
        Debug.log("Field Field form type XX: "+this.modelForm.getType()); 
        Debug.log("Field Field form location XX: "+this.modelForm.getFormLocation()); 
