...
public final class ComponentConfig {
    ...
    public static final class WebappInfo {
        ...
        private WebappInfo(ComponentConfig componentConfig, Element element) {
            ...
            //Aktham
            boolean inVersion = isInVersion(element.getAttribute("name"));
            this.location = element.getAttribute("location");
            
            Debug.logError("app-bar-display:"+element.getAttribute("app-bar-display"), module);
            Debug.logError("inVersion:"+inVersion, module);
            this.appBarDisplay = !"false".equals(element.getAttribute("app-bar-display")) && inVersion ;
        ...
        //Aktham
        public boolean isInVersion(String appBarDisplay) {
        	boolean isInVersion = false;
        	List<String> notInVersionApps = new ArrayList<String>();
        	notInVersionApps.add("accounting");
        	notInVersionApps.add("myaccounting");
        	notInVersionApps.add("partymgr");


        	for(String app: notInVersionApps) {
        		if(appBarDisplay.equals(app)) isInVersion = true;
        	}
        	return isInVersion;
        }
